...
<Note>
You can use the logger as a drop-in replacement for standard Pino loggers. See the [Custom Logging](/en/sdk/pipes-sdk/guides/customizing/logging) section for integration examples.
</Note>
