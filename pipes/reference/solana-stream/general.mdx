...
The following setters configure the global settings of `DataSourceBuilder` for Solana Processor. They return the modified instance and can be chained.
...
Adds a RPC data source. If added, it will be used for [RPC ingestion](/en/sdk/squid-sdk/features/unfinalized-blocks). The argument format is:
