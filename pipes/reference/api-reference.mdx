...
|----------|-------------|-----------|
| `solanaPortalSource()` | Creates a data source connected to Subsquid Portal | [Source](/en/sdk/pipes-sdk/solana/reference/basic-components/source) |
| `solanaInstructionDecoder()` | Decodes program instructions using ABIs | [Instruction Decoder](/en/sdk/pipes-sdk/solana/reference/utility-components/instruction-decoder) |
| `solanaRpcLatencyWatcher()` | Monitors RPC latency for performance tracking | [RPC Latency Watcher](/en/sdk/pipes-sdk/solana/reference/utility-components/rpc-latency-watcher) |
...
| Function | Description | Reference |
|----------|-------------|-----------|
| `createTransformer()` | Creates a data transformer | [Transformer](/en/sdk/pipes-sdk/solana/reference/basic-components/transformer) |
| `createTarget()` | Creates a custom data target | [Target](/en/sdk/pipes-sdk/solana/reference/basic-components/target) |
