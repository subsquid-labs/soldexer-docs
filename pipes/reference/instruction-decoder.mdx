...
<Tip>
Use the `AbiDecodeInstruction` type helper to extract the decoded instruction data type from your ABI for better TypeScript type safety. See the [Types & Methods reference](/en/sdk/pipes-sdk/solana/reference/types-methods#abidecodeinstruction) for details.
</Tip>
