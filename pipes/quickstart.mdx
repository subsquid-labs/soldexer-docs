---
title: "Quickstart"
description: "Get a Solana blockchain indexer in 5 minutes with Squid SDK"
mode: "wide"
---
...
Next, `main.ts` defines the data processing and storage logic. Data processing is defined in the _batch handler_, the callback that the `run()` function as its final argument:
