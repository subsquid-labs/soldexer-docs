---
title: "Why Pipes SDK?"
description: "Learn when to use Pipes SDK for Solana blockchain data."
---



<CardGroup cols={1}>
<Card title="EVM version" icon="book" href="/en/sdk/pipes-sdk/evm/quickstart">
...
<Frame>
  <img
    src="/images/pipes-flow.gif"
    alt="Animated diagram of a pipe: raw blocks from Portal are transformed by the pipe and written to the sink of your choice"
  />
</Frame>
...
1. If you want to use Portal data in an non-JS app, consider using
   - [Portal API](/en/portal/solana/api) for all languages.
