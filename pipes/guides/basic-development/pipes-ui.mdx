---
title: "Pipes UI"
description: "Monitor a Solana Pipes SDK pipeline with the live dashboard."
---
...
Pipes UI tracks multiple indexers in a single dashboard:

<Frame>
  <img
    src="/images/sdk/pipes/pipes-ui-multi-indexer-dashboard.png"
    alt="Pipes UI dashboard tracking many indexers at once, each card showing progress, ETA, indexing rate, download speed and process memory"
