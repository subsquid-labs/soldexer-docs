...
<Info>
When deploying to [Cloud](cloud) with the [Postgres addon](/en/cloud/reference/pg) enabled in the [manifest](/en/cloud/reference/manifest), any user-supplied values are overwritten for most of these variables. See [Variable shadowing](/en/cloud/reference/pg/#variable-shadowing).
</Info>
...
<Tip>
In case you're deploying to [Cloud](cloud) you can set [secrets](/en/cloud/resources/env-variables/#secrets) to the contents of any given file via stdin:
```bash
