...
Selection of the exact fields to be retrieved for each reward item is done with the `setFields()` method documented on the [Field selection](/en/sdk/squid-sdk/solana/sdk/solana-batch/field-selection) page.
