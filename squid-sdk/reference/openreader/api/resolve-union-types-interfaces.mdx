---
title: "Union Type Resolution"
description: "Use the __typename field to resolve types"
---

# Union Type Resolution

Use cases for [Union types](/en/sdk/squid-sdk/evm/reference/schema-file/unions-and-typed-json) have been discussed in the [schema reference](/en/sdk/squid-sdk/evm/reference/schema-file/intro). Here, we discuss how to query union types.

Let's take this modified schema from the [Substrate tutorial](/en/sdk/squid-sdk/substrate/tutorials/substrate):
